<x-guest-layout>
    <section class="ftco-section">
        <div class="container">
            {{-- <div class="row mb-5">
                <div class="col-md-8">
                    <form method="GET" action="{{ route('front.tournament.index') }}" class="form-inline">
                        <div class="form-group mr-3">
                            <label for="tournament_id" class="mr-2">Seleccionar Torneo</label>
                            <select name="tournament_id" id="tournament_id" class="form-control">
                                @foreach($allTournaments as $tournamentOption)
                                    <option value="{{ $tournamentOption->id }}"
                                        {{ (old('tournament_id', $currentTournament->id) == $tournamentOption->id) ? 'selected' : '' }}>
            ...
            <div class="container">
                <div class="row mb-5">
                    ...
                    <div class="col-md-7 d-flex flex-column align-items-start order-2 order-md-1">
                        ...
                        <p><strong>Inicio:</strong> {{ $currentTournament->start_date }}</p>
                        <p><strong>Fin:</strong> {{ $currentTournament->end_date }}</p>
                        <p><strong>Ubicación:</strong> {{ $currentTournament->location }}</p>
                        <p><strong>Estado:</strong> {{ $currentTournament->status }}</p>
                    </div>
            ...
            <div class="container">
                <div class="row mb-6">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            <div class="col-auto">
                                <form method="GET" action="{{ route('front.tournament', $currentTournament->id) }}"
                                    class="form-inline">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card-body p-2">
                                                ...
                                                <p class="card-text mb-1">
                                                    <span class="team" style="color: #3e0171">{{
                                                        $fixture->homeTeam->name }}</span>
                                                    <span class="score" style="color: #000">{{ $fixture->home_team_score
                                                        ?? '0' }}</span>
                                                    -
                                                    <span class="score" style="color: #000">{{ $fixture->away_team_score
                                                        ?? '0' }}</span>
                                                    <span class="team" style="color: #3e0171">{{
                                                        $fixture->awayTeam->name }}</span>
                                                </p>
                                                <p class="card-text">
                                                ...
                                                <button class="btn btn-primary btn-sm" type="button"
                                                    data-toggle="collapse" data-target="#events_{{ $fixture->id }}"
                                                    aria-expanded="false" aria-controls="events_{{ $fixture->id }}">
                                                    Mostrar Eventos
                                                </button>
    ...
    <style>
        ...
        .publicidad {
            max-width: 48%;
            /* Ajusta este valor según sea necesario para que los logos quepan uno al lado del otro */
        }
