                ...
                <div class="volunteer pl-md-5 ftco-animate">
                    ...
                    <form  method="POST" action="{{ route('login') }}" class="volunter-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="border: 2px solid rgba(0, 0, 0, 0.7); color:rgba(0, 0, 0, 0.7) !important;" class="form-control" placeholder="Email">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Iniciar Sesion" class="btn btn-white py-3 px-5">
                        </div>
                    </form>
                </div>    			
            </div>
